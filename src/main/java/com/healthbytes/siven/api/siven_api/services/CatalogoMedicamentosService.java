...
public interface CatalogoMedicamentosService {
        ...
        // Métodos para TratamientosSeguimiento

        // Metodo para obtener todos los tratamientos seguimiento
        List<TratamientosSeguimiento> listAllTratamientosSeguimiento();

        // Metodo para buscar un tratamientos seguimiento
        Optional<TratamientosSeguimiento> getTratamientoSeguimientoById(int id_tratamiento);

        // Metodo para crear un tratamientos seguimiento
        TratamientosSeguimiento saveTratamientosSeguimiento(TratamientosSeguimiento tratamientosSeguimiento);

        // Metodo para actualizar un tratamientos seguimiento
        Optional<TratamientosSeguimiento> updateTratamientosSeguimiento(int id_tratamiento,
                        TratamientosSeguimiento tratamientosSeguimiento);

        // Metodo para borrar un tratamientos seguimiento
        Optional<TratamientosSeguimiento> deleteTratamientosSeguimiento(int id_tratamiento);
